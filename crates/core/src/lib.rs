...
pub fn solve(
    ...
    let result = match (year, day, part) {
        ...
        (2017, 1, _) => to_stringer_input(year2017::day01::solve, &mut input),
        (2017, 2, _) => to_stringer_input(year2017::day02::solve, &mut input),
        (2017, 3, _) => to_stringer_input(year2017::day03::solve, &mut input),
        (2017, 4, _) => to_stringer_input(year2017::day04::solve, &mut input),
        (2017, 5, _) => to_stringer_input(year2017::day05::solve, &mut input),
        (2017, 6, _) => to_stringer_input(year2017::day06::solve, &mut input),
        (2017, 7, _) => to_stringer_input(year2017::day07::solve, &mut input),
        (2017, 8, _) => to_stringer_input(year2017::day08::solve, &mut input),
        (2017, 9, _) => to_stringer_input(year2017::day09::solve, &mut input),
        (2017, 10, _) => to_stringer_input(year2017::day10::solve, &mut input),
        (2017, 11, _) => to_stringer_input(year2017::day11::solve, &mut input),
        ...
        (2018, 1, _) => to_stringer_input(year2018::day01::solve, &mut input),
        (2018, 2, _) => to_stringer_input(year2018::day02::solve, &mut input),
        (2018, 3, _) => to_stringer_input(year2018::day03::solve, &mut input),
        (2018, 4, _) => to_stringer_input(year2018::day04::solve, &mut input),
        (2018, 5, _) => to_stringer_input(year2018::day05::solve, &mut input),
        (2018, 6, _) => to_stringer_input(year2018::day06::solve, &mut input),
        (2018, 7, _) => to_stringer_input(year2018::day07::solve, &mut input),
        (2018, 8, _) => to_stringer_input(year2018::day08::solve, &mut input),
        (2018, 9, _) => to_stringer_input(year2018::day09::solve, &mut input),
        (2018, 10, _) => to_stringer_input(year2018::day10::solve, &mut input),
        (2018, 11, _) => to_stringer_input(year2018::day11::solve, &mut input),
        (2018, 12, _) => to_stringer_input(year2018::day12::solve, &mut input),
        (2018, 13, _) => to_stringer_input(year2018::day13::solve, &mut input),
        (2018, 14, _) => to_stringer_input(year2018::day14::solve, &mut input),
        (2018, 15, _) => to_stringer_input(year2018::day15::solve, &mut input),
        (2018, 16, _) => to_stringer_input(year2018::day16::solve, &mut input),
        (2018, 17, _) => to_stringer_input(year2018::day17::solve, &mut input),
        (2018, 18, _) => to_stringer_input(year2018::day18::solve, &mut input),
        (2018, 19, _) => to_stringer_input(year2018::day19::solve, &mut input),
        (2018, 20, _) => to_stringer_input(year2018::day20::solve, &mut input),
        (2018, 21, _) => to_stringer_input(year2018::day21::solve, &mut input),
        (2018, 22, _) => to_stringer_input(year2018::day22::solve, &mut input),
        (2018, 23, _) => to_stringer_input(year2018::day23::solve, &mut input),
        (2018, 24, _) => to_stringer_input(year2018::day24::solve, &mut input),
        (2018, 25, _) => to_stringer_input(year2018::day25::solve, &mut input),
        (2019, 1, _) => to_stringer_input(year2019::day01::solve, &mut input),
        (2019, 2, _) => to_stringer_input(year2019::day02::solve, &mut input),
        (2019, 3, _) => to_stringer_input(year2019::day03::solve, &mut input),
        (2019, 4, _) => to_stringer_input(year2019::day04::solve, &mut input),
        (2019, 5, _) => to_stringer_input(year2019::day05::solve, &mut input),
        (2019, 6, _) => to_stringer_input(year2019::day06::solve, &mut input),
        (2019, 7, _) => to_stringer_input(year2019::day07::solve, &mut input),
        (2019, 8, _) => to_stringer_input(year2019::day08::solve, &mut input),
