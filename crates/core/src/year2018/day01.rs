...
mod tests {
    use std::collections::HashSet;
    pub fn part2_scan(input_string: &str) -> Result<i32, String> {
        let mut seen_frequencies = HashSet::new();
...
fn tests_part2() {
    ...
    assert_eq!(Ok(0), tests::part2_scan("+1,-1"));
    assert_eq!(Ok(10), tests::part2_scan("+3,+3,+4,-2,-4"));
    assert_eq!(Ok(5), tests::part2_scan("-6,+3,+8,+5,-6"));
    assert_eq!(Ok(14), tests::part2_scan("+7,+7,-2,-7,-4"));
}
